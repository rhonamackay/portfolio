export const projectData = [
    ...
    },
    {
        ...
        deployedURL: 'https://rhonamackay.github.io/trivia-api-app/',
        gitURL: 'https://github.com/rhonamackay/trivia-api-app',
        gallery: ['/quiz-1.png', '/quiz-2.png', '/quiz-3.png']
    },
    {
        name: 'podcast-recs',
        displayName: "Rhona's finest podcast episode recommendations",
        desc: "An app for providing my best podcast episode recommendations. Made using create react app.",
        stack: ['JavaScript', 'React', 'CSS'],
        deployedURL: 'https://rhonamackay.github.io/podcast-recs/',
        gitURL: 'https://github.com/rhonamackay/podcast-recs',
